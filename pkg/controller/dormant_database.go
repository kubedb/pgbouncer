...
//}
//
//func (c *Controller) waitUntilRBACStuffDeleted(pgbouncer *api.PgBouncer) error {
//	// Delete Existing Role
//	if err := rbac_util.WaitUntillRoleDeleted(c.Client, pgbouncer.ObjectMeta); err != nil {
//		return err
//	}
//
//	// Delete RoleBinding
//	if err := rbac_util.WaitUntillRoleBindingDeleted(c.Client, pgbouncer.ObjectMeta); err != nil {
//		return err
//	}
//
//	// Delete ServiceAccount
//	if err := core_util.WaitUntillServiceAccountDeleted(c.Client, pgbouncer.ObjectMeta); err != nil {
//		return err
//	}
//
//	// Delete Snapshot ServiceAccount
//	snapSAMeta := metav1.ObjectMeta{
//		Name:      pgbouncer.SnapshotSAName(),
...
//}
//
//func (c *Controller) deleteMatchingDormantDatabase(pgbouncer *api.PgBouncer) error {
//	// Check if DormantDatabase exists or not
//	ddb, err := c.ExtClient.KubedbV1alpha1().DormantDatabases(pgbouncer.Namespace).Get(pgbouncer.Name, metav1.GetOptions{})
//	if err != nil {
...
//	if err := c.ExtClient.KubedbV1alpha1().DormantDatabases(pgbouncer.Namespace).Delete(pgbouncer.Name,
...
//}
//
//func (c *Controller) createDormantDatabase(pgbouncer *api.PgBouncer) (*api.DormantDatabase, error) {
...
//					Name:              pgbouncer.Name,
//					Namespace:         pgbouncer.Namespace,
//					Labels:            pgbouncer.Labels,
//					Annotations:       pgbouncer.Annotations,
//					CreationTimestamp: pgbouncer.CreationTimestamp,
//				},
//				Spec: api.OriginSpec{
//					PgBouncer: &(pgbouncer.Spec),
//				},
//			},
//		},
//	}
