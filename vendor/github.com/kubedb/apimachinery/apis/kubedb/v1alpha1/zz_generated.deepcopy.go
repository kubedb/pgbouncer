...
func (in *PgBouncerSchemaInfo) DeepCopyInto(out *PgBouncerSchemaInfo) {
	*out = *in
	if in.Table != nil {
		...
		*out = make(map[string]*PgBouncerTableInfo, len(*in))
		for key, val := range *in {
			var outVal *PgBouncerTableInfo
			if val == nil {
				(*out)[key] = nil
			} else {
				in, out := &val, &outVal
				*out = new(PgBouncerTableInfo)
				**out = **in
			}
			(*out)[key] = outVal
		}
...
func (in *PgBouncerSummary) DeepCopyInto(out *PgBouncerSummary) {
	*out = *in
	if in.Schema != nil {
		...
		*out = make(map[string]*PgBouncerSchemaInfo, len(*in))
		for key, val := range *in {
			var outVal *PgBouncerSchemaInfo
			if val == nil {
				(*out)[key] = nil
			} else {
				in, out := &val, &outVal
