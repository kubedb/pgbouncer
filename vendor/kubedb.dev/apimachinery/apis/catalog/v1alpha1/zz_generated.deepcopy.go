...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PgBouncerVersionPodSecurityPolicy) DeepCopyInto(out *PgBouncerVersionPodSecurityPolicy) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PgBouncerVersionPodSecurityPolicy.
func (in *PgBouncerVersionPodSecurityPolicy) DeepCopy() *PgBouncerVersionPodSecurityPolicy {
	if in == nil {
		return nil
	}
	out := new(PgBouncerVersionPodSecurityPolicy)
	in.DeepCopyInto(out)
	return out
}
