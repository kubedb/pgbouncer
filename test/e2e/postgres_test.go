...
import (
	...
	"github.com/kubedb/pgbouncer/test/e2e/matcher"
...
var _ = Describe("Postgres", func() {
	...
	Describe("Test", func() {
							...
							ScriptSource: &api.ScriptSourceSpec{
								VolumeSource: core.VolumeSource{
									GitRepo: &core.GitRepoVolumeSource{
										Repository: "https://github.com/kubedb/pgbouncer-init-scripts.git",
										Directory:  ".",
									},
								},
							},
		...
		Context("Initialize", func() {
			...
			// `github.com/kubedb/pgbouncer/hack/dev/examples/stash01_config.yaml`
